...
public class part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO user(name, email) VALUES('노영준', 'shdudwns59@gmail.com');";
  ...
  */
  public static final String PART2_7 = "SELECT c.title, u.name from content c left join user u on u.id = c.userid;";
  ...
  */
  public static final String PART2_8 = "select c.title, u.name from content c join user u on u.id = c.userid;";
  ...
  */
  public static final String PART2_10 = "INSERT INTO content( title, body,userid) VALUES('럭키가 쓴 글', '안녕하세요',1); ";
}
